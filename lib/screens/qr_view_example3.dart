...
class QRViewExample3 extends StatefulWidget {
  static const routeName = '/qr-view3';
  const QRViewExample3({Key? key}) : super(key: key);
  @override
  _QRViewExample3State createState() => _QRViewExample3State();
}

class _QRViewExample3State extends State<QRViewExample3> {
